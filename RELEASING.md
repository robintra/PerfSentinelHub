...
```text
python3 scripts/verify-release.py public-input v0.3.1
python3 scripts/verify-release.py public-input https://github.com/robintra/PerfSentinelHub/releases/tag/v0.3.1
```
...
cosign verify-blob --bundle release/ARTIFACT.sigstore.json \
  --certificate-identity https://github.com/robintra/PerfSentinelHub/.github/workflows/release.yml@refs/tags/v0.3.1 \
...
gh attestation verify release/ARTIFACT --bundle release/release.provenance.sigstore.json \
  ...
  --cert-identity https://github.com/robintra/PerfSentinelHub/.github/workflows/release.yml@refs/tags/v0.3.1 \
  --cert-oidc-issuer https://token.actions.githubusercontent.com \
  --source-ref refs/tags/v0.3.1 --source-digest SOURCE_COMMIT --deny-self-hosted-runners
```
