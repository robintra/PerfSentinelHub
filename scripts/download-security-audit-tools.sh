...
/usr/bin/curl -q -fsSL --retry 5 --retry-all-errors --retry-delay 2 https://github.com/google/osv-scanner/releases/download/v2.5.0/osv-scanner_linux_amd64 -o tools/osv-scanner
/usr/bin/printf 'edcfc41d257db36148f065055655fe3fcfc434b0b423ea67468a84c207524e0c  tools/osv-scanner\n' | /usr/bin/sha256sum -c -
/usr/bin/curl -q -fsSL --retry 5 --retry-all-errors --retry-delay 2 https://github.com/anchore/syft/releases/download/v1.50.0/syft_1.50.0_linux_amd64.tar.gz -o tools/syft.tar.gz
