...
// up four fake daemons and a real Hub before any of this runs.
    ...
    projects: [
        {
            ...
            use: {
                ...devices["Desktop Chrome"], viewport: VIEWPORT, colorScheme: "dark",
        ...
        },
        {
            ...
            testMatch: "tour.spec.ts",
            use: {
                ...devices["Desktop Chrome"], viewport: VIEWPORT, colorScheme: "light",
                video: {mode: "on", size: VIEWPORT}
            }
        },
        {
