...
```text
python3 scripts/verify-release.py public-input v0.1.10
python3 scripts/verify-release.py public-input https://github.com/robintra/PerfSentinelHub/releases/tag/v0.1.10
```
...
cosign verify-blob --bundle release/ARTIFACT.sigstore.json \
  --certificate-identity https://github.com/robintra/PerfSentinelHub/.github/workflows/release.yml@refs/tags/v0.1.10 \
...
gh attestation verify release/ARTIFACT --bundle release/release.provenance.sigstore.json \
  ...
  --cert-identity https://github.com/robintra/PerfSentinelHub/.github/workflows/release.yml@refs/tags/v0.1.10 \
  --cert-oidc-issuer https://token.actions.githubusercontent.com \
  --source-ref refs/tags/v0.1.10 --source-digest SOURCE_COMMIT --deny-self-hosted-runners
```
